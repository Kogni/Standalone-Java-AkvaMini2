...
public class Panel_Equipment_Varme extends JPanel implements ActionListener {
	...
	public Panel_Equipment_Varme(Communicator Class_CommunicatorT) {
        ...
        Text[1][1].setText("Heater: ");
        Text[2][1].setText(" Age(months): ");
        Text[3][1].setText(" Effect: ");
        Text[4][1].setText(" Set temperature: ");
        Text[5][1].setText(" Temperature now: ");
