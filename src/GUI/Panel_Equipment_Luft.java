...
public class Panel_Equipment_Luft extends JPanel implements ActionListener {
	...
	public Panel_Equipment_Luft(Communicator Class_CommunicatorT) {
        ...
        Text[1][1].setText("Air: ");
        Text[2][1].setText(" Effect: ");
