...
public class Panel_Equipment_Akvarie extends JPanel implements ActionListener {
	...
	public Panel_Equipment_Akvarie(Communicator Class_CommunicatorT) {
        ...
        Text[1][1].setText("Aquarium: ");
        Text[2][1].setText(" Volume: ");
        Text[3][1].setText(" Water: ");
        Text[4][1].setText(" Cm fish/liter: ");
	...
	public void FillLabels() {
		...
		Text[2][2].setText(Class_Communicator.Class_Brain_Equipment.InUse_Akvarie.Bonuser.WaterCapacity+"l");
		Text[3][2].setText(Class_Communicator.Class_Brain_Akvarie.VannIAkvarie+"l");
		Text[4][2].setText(Class_Communicator.Class_Brain_Fish.CMFishPerLiter+" cm/l");
